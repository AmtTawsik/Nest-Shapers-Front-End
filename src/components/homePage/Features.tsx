    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="mb-8 lg:mb-16 text-center">
          <h2 className="mb-4 text-3xl md:text-6xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Key Features that Shape Your Nest</h2>
          <p className="text-gray-500 text-xl md:text-2xl dark:text-gray-400">Discover the Pillars of Excellence Defining Our House Servicing Solutions</p>
        </div>
